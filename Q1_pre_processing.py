...
x_transformer = Pipeline([
    ...
    # ('DefineNA-Anony15', AssignMissingValue(constant=pd.to_datetime('2100-12-31', format='%Y-%m-%d'),
    #                                         cols=['anonymous_15'])),
    # ('Duration-Anony15', TimeDuration(start_date='anonymous_15', end_date='tradeTime', new_name='anonymous_15_age')),
